defmodule LifelineWeb.Router do
  use LifelineWeb, :router

  import LifelineWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {LifelineWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: LifelineWeb.Telemetry
    end
  end
